	    ...
	    <div class="box-main-center">	
		 <div class="main">
			 ...
			 <?php
			    ...
			    if(isset($_GET["page"])){//Pecisa estar preenchida a variavel page
					...
					if($_GET["page"] == "newcaduser"){
					   ...
					   areaUser( $dados["user_id"] );
						...
						windowLoginUser();//se não estiver com valor SESSION[login], não navega no site
						exit();//execulta e para
							...
							if(isset($_SESSION['login']))//ececuta essas condições apenas se estiver logado
							{
								//necessitam de estar logados para efetuar as alterações
							...
							}//fecha if(isset($_SESSION['login']), só executa essas ações se estiver logado
				}else{
					?>
								<script>
									//redireciona a página (Refresh)
